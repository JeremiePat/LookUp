;(() => {
  ...
  class SimpleStorage {
     ...
     *
     * If no id (or inknown id) is provided, then an object
     * containing all the key/value pair is returned
     *
     * @param { String } id The id of the value to retreive
     * @return { Promise } A promise that will provide the expected value
     */
    async get (id) {
