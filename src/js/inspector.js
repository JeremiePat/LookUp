;(() => {
  ...
  const counter = {
    ...
    /**
     * Count the number of match of a given pattern against the text content of the document
     *
     * @param  { String } pattern The text pattern to search
     * @return { Number }
     */
    text (pattern) {
   ...
   *
   * @param  { Object  } rule The test to perform
   * @return { Boolean }
   */
